...
export default function Header() {
  ...
  return (
    <AppBar position="static" elevation={0} sx={{ bgcolor: 'background.paper', borderBottom: '1px solid', borderColor: 'divider', py: 0.5 }}>
      <Container maxWidth="xl">
        <Toolbar sx={{ minHeight: 56, px: '0 !important' }}>
